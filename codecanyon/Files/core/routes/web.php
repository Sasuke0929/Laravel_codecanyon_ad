...
Route::namespace('Gateway')->prefix('ipn')->name('ipn.')->group(function () {
    ...
    Route::post('faucetpay', 'faucetpay\ProcessController@ipn')->name('faucetpay');
});
...
Route::namespace('Publisher')->prefix('publisher')->name('publisher.')->group(function () {
    ...
    Route::middleware(['publisher','checkStatus:publisher'])->group(function () {
        ...
        Route::get('referrals', 'PublisherController@referrals')->name('referrals');
        Route::post('referrals', 'PublisherController@referralsInsert')->name('referrals.insert');
    });
 });
...
Route::get('getName', 'SiteController@getName')->name('getName');
