    ...
    <div class="navbar__right">
      <ul class="main-menu d-flex flex-wrap align-items-center">
        ...
        <li class="dropdown">
          ...
          <label for="my-select" style="display:flex;font-size:12px">@lang('Balance: ')$<span id="getbalance_value">{{ getAmount(auth()->guard('advertiser')->user()->balance) }}</span></label>
          <div class="dropdown-menu dropdown-menu--sm p-0 border-0 box--shadow1 dropdown-menu-right">
...
@push('script')
  <script>
      'use strict';
      (function ($) {
        var val = parseFloat($("#getbalance_value").text());
        $("#getbalance_value").text(val.toFixed(2));
      })(jQuery); 
  </script>
@endpush
