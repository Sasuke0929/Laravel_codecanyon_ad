                            ...
                            @forelse($types as $type)
                                <tr>
                                    ...
                                    <td data-label="@lang('Width')"><span
                                            class="text--small badge font-weight-normal badge--dark">{{ $type->type == 'Direct Link' || $type->type == 'Native' || $type->type == 'Pop ads' ? '' : $type->width.'px' }}</span>
                                    </td>
                                    <td data-label="@lang('Height')"><span
                                            class="text--small badge font-weight-normal badge--dark">{{ $type->type == 'Direct Link' || $type->type == 'Native' || $type->type == 'Pop ads' ? '' : $type->height.'px' }}</span>
                                    </td>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label class="form-control-label  font-weight-bold">@lang('Ad Type')<span
                                                class="text-danger">*</span></label>
                                        <select name="adType" class="form-control" id="select_type">
                                            <option disabled>@lang('--Select type--')</option>
                                            <option value="Banners">@lang('Banners')</option>
                                            <option value="Pop ads">@lang('Pop ads')</option>
                                            <option value="Direct Link">@lang('Direct Link')</option>
                ...
                <form action="" method="POST" enctype="multipart/form-data">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label class="form-control-label  font-weight-bold">@lang('Ad Type')<span
                                                class="text-danger">*</span></label>
                                        <select name="adType" class="form-control" id="select_type1">
                                            <option disabled>@lang('--Select type--')</option>
                                            <option value="Banners">@lang('Banners')</option>
                                            <option value="Pop ads">@lang('Pop ads')</option>
                                            <option value="Direct Link">@lang('Direct Link')</option>
                            ...
                            <div class="row" id="slug_columns1">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label class="form-control-label  font-weight-bold">@lang('Slug')<span
                                                class="text-danger">*</span></label>
                                        <input class="form-control" type="text" placeholder="{{trans('slug')}}"
                                               id="s" name="slug" value="" required readonly>
                                    </div>
                                </div>
                            </div>
...
@push('script')
    <script>
        ...
        $("#select_type1").on('change', function(){
            var selval = $("#select_type1").val();
            switch(selval){
                case 'Banners':
                    $("#standards1").show();
                    $("#slug_columns1").show();
        ...
        $('.edit').on('click', function () {
            ...
            modal.find('select[name=adType]').val(type)
