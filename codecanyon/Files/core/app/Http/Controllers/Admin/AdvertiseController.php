...
class AdvertiseController extends Controller
{
    ...
    public function updateType(Request $request,$id)
    {
        ...
        $request->validate([
            ...
            'slug'=>'unique:ad_types,slug,'.$adType->id,
        ]);
        ...
        $adType->width = $request->adType === 'Direct Link' || $request->adType === 'Native' || $request->adType === 'Pop ads' ? null : $request->width;
        $adType->height = $request->adType === 'Direct Link' || $request->adType === 'Native' || $request->adType === 'Pop ads' ? null : $request->height;
        $adType->slug = $request->adType === 'Direct Link' || $request->adType === 'Native' || $request->adType === 'Pop ads' ? null : $request->width.'x'.$request->height;
